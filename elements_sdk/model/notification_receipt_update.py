...
class NotificationReceiptUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, notify_type, notification, *args, **xkwargs):  # noqa: E501
        """NotificationReceiptUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, notify_type, notification, *args, **xkwargs):  # noqa: E501
        """NotificationReceiptUpdate - a model defined in OpenAPI
