...
class EmailStyling(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, background, backdrop, primary, *args, **xkwargs):  # noqa: E501
        """EmailStyling - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, background, backdrop, primary, *args, **xkwargs):  # noqa: E501
        """EmailStyling - a model defined in OpenAPI
