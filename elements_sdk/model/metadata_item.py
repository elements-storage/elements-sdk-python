...
class MetadataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, custom_fields, tags, path, *args, **xkwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, custom_fields, tags, path, *args, **xkwargs):  # noqa: E501
        """MetadataItem - a model defined in OpenAPI
