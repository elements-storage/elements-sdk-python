...
class VolumeBeeGFSStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'nodes': ([BeeGFSNode],),  # noqa: E501
            'targets': ([BeeGFSTarget],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, nodes, targets, *args, **xkwargs):  # noqa: E501
        """VolumeBeeGFSStatus - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, nodes, targets, *args, **xkwargs):  # noqa: E501
        """VolumeBeeGFSStatus - a model defined in OpenAPI
