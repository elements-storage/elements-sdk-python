...
class TimeSyncEndpointRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, server, *args, **xkwargs):  # noqa: E501
        """TimeSyncEndpointRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, server, *args, **xkwargs):  # noqa: E501
        """TimeSyncEndpointRequest - a model defined in OpenAPI
