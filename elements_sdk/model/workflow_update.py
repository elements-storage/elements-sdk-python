...
class WorkflowUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, states, transitions, name, *args, **xkwargs):  # noqa: E501
        """WorkflowUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, states, transitions, name, *args, **xkwargs):  # noqa: E501
        """WorkflowUpdate - a model defined in OpenAPI
