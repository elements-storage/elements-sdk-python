...
class LDAPProbeResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tls, domain, nt_domain, base_dn, *args, **xkwargs):  # noqa: E501
        """LDAPProbeResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, tls, domain, nt_domain, base_dn, *args, **xkwargs):  # noqa: E501
        """LDAPProbeResponse - a model defined in OpenAPI
