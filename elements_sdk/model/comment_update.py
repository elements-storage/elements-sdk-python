...
class CommentUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, asset, *args, **xkwargs):  # noqa: E501
        """CommentUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset, *args, **xkwargs):  # noqa: E501
        """CommentUpdate - a model defined in OpenAPI
