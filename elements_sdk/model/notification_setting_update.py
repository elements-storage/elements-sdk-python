...
class NotificationSettingUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, topic, type, user, *args, **xkwargs):  # noqa: E501
        """NotificationSettingUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, topic, type, user, *args, **xkwargs):  # noqa: E501
        """NotificationSettingUpdate - a model defined in OpenAPI
