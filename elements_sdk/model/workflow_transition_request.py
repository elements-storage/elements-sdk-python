...
class WorkflowTransitionRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, job, root, *args, **xkwargs):  # noqa: E501
        """WorkflowTransitionRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, job, root, *args, **xkwargs):  # noqa: E501
        """WorkflowTransitionRequest - a model defined in OpenAPI
