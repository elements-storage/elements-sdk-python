...
class LDAPServerGroups(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'groups': ([LDAPServerGroup],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, groups, *args, **xkwargs):  # noqa: E501
        """LDAPServerGroups - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, groups, *args, **xkwargs):  # noqa: E501
        """LDAPServerGroups - a model defined in OpenAPI
