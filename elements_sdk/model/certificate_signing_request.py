...
class CertificateSigningRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, country, state, locality, organization, organizational_unit, common_name, email, *args, **xkwargs):  # noqa: E501
        """CertificateSigningRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, country, state, locality, organization, organizational_unit, common_name, email, *args, **xkwargs):  # noqa: E501
        """CertificateSigningRequest - a model defined in OpenAPI
