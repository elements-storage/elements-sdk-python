...
class AICategory(ModelNormal):
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'annotation_count': 'annotation_count',  # noqa: E501
        'sample_annotation': 'sample_annotation',  # noqa: E501
    ...
    read_only_vars = {
        'annotation_count',  # noqa: E501
        'sample_annotation',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, annotation_count, sample_annotation, connection, name, dataset, *args, **xkwargs):  # noqa: E501
        """AICategory - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, dataset, *args, **xkwargs):  # noqa: E501
        """AICategory - a model defined in OpenAPI
