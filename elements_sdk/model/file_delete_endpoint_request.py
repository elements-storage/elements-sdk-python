...
class FileDeleteEndpointRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, input, *args, **xkwargs):  # noqa: E501
        """FileDeleteEndpointRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, input, *args, **xkwargs):  # noqa: E501
        """FileDeleteEndpointRequest - a model defined in OpenAPI
