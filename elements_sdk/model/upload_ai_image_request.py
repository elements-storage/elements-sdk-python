...
class UploadAIImageRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, content, category, *args, **xkwargs):  # noqa: E501
        """UploadAIImageRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, content, category, *args, **xkwargs):  # noqa: E501
        """UploadAIImageRequest - a model defined in OpenAPI
