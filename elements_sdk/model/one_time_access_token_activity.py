...
class OneTimeAccessTokenActivity(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, date, ip, token, *args, **xkwargs):  # noqa: E501
        """OneTimeAccessTokenActivity - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, ip, token, *args, **xkwargs):  # noqa: E501
        """OneTimeAccessTokenActivity - a model defined in OpenAPI
