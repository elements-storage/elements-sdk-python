...
class LDAPServerUsers(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, users, *args, **xkwargs):  # noqa: E501
        """LDAPServerUsers - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, users, *args, **xkwargs):  # noqa: E501
        """LDAPServerUsers - a model defined in OpenAPI
