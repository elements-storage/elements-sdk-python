...
class ZipInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, is_dir, size, *args, **xkwargs):  # noqa: E501
        """ZipInfo - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, size, *args, **xkwargs):  # noqa: E501
        """ZipInfo - a model defined in OpenAPI
