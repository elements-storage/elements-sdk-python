...
class GetMediaFileByPathRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, path, volume, *args, **xkwargs):  # noqa: E501
        """GetMediaFileByPathRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, path, volume, *args, **xkwargs):  # noqa: E501
        """GetMediaFileByPathRequest - a model defined in OpenAPI
