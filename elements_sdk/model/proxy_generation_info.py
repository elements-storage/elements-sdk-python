...
class ProxyGenerationInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'progress': ({str: (str, none_type)},),  # noqa: E501
            'state': (int,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, progress, state, *args, **xkwargs):  # noqa: E501
        """ProxyGenerationInfo - a model defined in OpenAPI

        Args:
            progress ({str: (str, none_type)}):
            state (int):
    ...
    @convert_js_args_to_python_args
    def __init__(self, progress, state, *args, **xkwargs):  # noqa: E501
        """ProxyGenerationInfo - a model defined in OpenAPI
