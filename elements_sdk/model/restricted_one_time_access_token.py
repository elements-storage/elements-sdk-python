...
class RestrictedOneTimeAccessToken(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, has_password, user, url, full_url, *args, **xkwargs):  # noqa: E501
        """RestrictedOneTimeAccessToken - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, user, url, *args, **xkwargs):  # noqa: E501
        """RestrictedOneTimeAccessToken - a model defined in OpenAPI
