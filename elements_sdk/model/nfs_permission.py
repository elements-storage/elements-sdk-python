...
class NFSPermission(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, host, read_only, options, *args, **xkwargs):  # noqa: E501
        """NFSPermission - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, host, read_only, options, *args, **xkwargs):  # noqa: E501
        """NFSPermission - a model defined in OpenAPI
