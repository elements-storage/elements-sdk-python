...
def lazy_import():
    ...
    globals()['CephHealthCheck'] = CephHealthCheck


class CephHealth(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'checks': ({str: (CephHealthCheck,)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, checks, *args, **xkwargs):  # noqa: E501
        """CephHealth - a model defined in OpenAPI

        Args:
            status (str):
            checks ({str: (CephHealthCheck,)}):
    ...
    @convert_js_args_to_python_args
    def __init__(self, checks, *args, **xkwargs):  # noqa: E501
        """CephHealth - a model defined in OpenAPI
