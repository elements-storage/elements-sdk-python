...
class VolumeSNFSStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'stripe_groups': ([SNFSStripeGroup],),  # noqa: E501
        }
    ...
    attribute_map = {
        'stripe_groups': 'stripe_groups',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, stripe_groups, *args, **xkwargs):  # noqa: E501
        """VolumeSNFSStatus - a model defined in OpenAPI

        Args:
            stripe_groups ([SNFSStripeGroup]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, stripe_groups, *args, **xkwargs):  # noqa: E501
        """VolumeSNFSStatus - a model defined in OpenAPI
