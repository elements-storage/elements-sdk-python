...
class MediaFileContents(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'directories': ([MediaFile],),  # noqa: E501
            'bundles': ([MediaFileBundle],),  # noqa: E501
            'total': (int,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, directories, bundles, total, *args, **xkwargs):  # noqa: E501
        """MediaFileContents - a model defined in OpenAPI

        Args:
            directories ([MediaFile]):
            bundles ([MediaFileBundle]):
            total (int):
    ...
    @convert_js_args_to_python_args
    def __init__(self, total, *args, **xkwargs):  # noqa: E501
        """MediaFileContents - a model defined in OpenAPI
