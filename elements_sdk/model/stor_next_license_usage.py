...
class StorNextLicenseUsage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, usage, total, *args, **xkwargs):  # noqa: E501
        """StorNextLicenseUsage - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, usage, total, *args, **xkwargs):  # noqa: E501
        """StorNextLicenseUsage - a model defined in OpenAPI
