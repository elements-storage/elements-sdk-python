...
class Workflow(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, states, transitions, roots, jobs, name, *args, **xkwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, states, transitions, roots, name, *args, **xkwargs):  # noqa: E501
        """Workflow - a model defined in OpenAPI
