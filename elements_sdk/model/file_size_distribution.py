...
class FileSizeDistribution(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'distribution': ([FileSizeDistributionItem],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, distribution, *args, **xkwargs):  # noqa: E501
        """FileSizeDistribution - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, distribution, *args, **xkwargs):  # noqa: E501
        """FileSizeDistribution - a model defined in OpenAPI
