...
class OneFSIntegration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, known_addresses, name, address, username, password, zone, address_override, *args, **xkwargs):  # noqa: E501
        """OneFSIntegration - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, known_addresses, name, address, username, password, zone, address_override, *args, **xkwargs):  # noqa: E501
        """OneFSIntegration - a model defined in OpenAPI
