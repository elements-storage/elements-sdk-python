...
class LocateMetadataEndpointResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'path': (str,),  # noqa: E501
            'markers': ([EditorMarker],),  # noqa: E501
            'tags': ([UnfilteredTag],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, path, markers, tags, *args, **xkwargs):  # noqa: E501
        """LocateMetadataEndpointResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, path, markers, *args, **xkwargs):  # noqa: E501
        """LocateMetadataEndpointResponse - a model defined in OpenAPI
