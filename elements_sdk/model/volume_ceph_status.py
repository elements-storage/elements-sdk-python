...
def lazy_import():
    ...
    globals()['CephClusterStatus'] = CephClusterStatus
    globals()['CephFsStatus'] = CephFsStatus


class VolumeCephStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'fs': (CephFsStatus,),  # noqa: E501
            'cluster': (CephClusterStatus,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fs, cluster, *args, **xkwargs):  # noqa: E501
        """VolumeCephStatus - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, fs, cluster, *args, **xkwargs):  # noqa: E501
        """VolumeCephStatus - a model defined in OpenAPI
