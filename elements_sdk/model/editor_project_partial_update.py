...
class EditorProjectPartialUpdate(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **xkwargs):  # noqa: E501
        """EditorProjectPartialUpdate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            project ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
        """
