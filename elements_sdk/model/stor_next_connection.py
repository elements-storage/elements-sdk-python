...
class StorNextConnection(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, index, type, *args, **xkwargs):  # noqa: E501
        """StorNextConnection - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, index, type, *args, **xkwargs):  # noqa: E501
        """StorNextConnection - a model defined in OpenAPI
