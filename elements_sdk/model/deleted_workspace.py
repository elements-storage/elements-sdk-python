...
class DeletedWorkspace(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, path, *args, **xkwargs):  # noqa: E501
        """DeletedWorkspace - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, path, *args, **xkwargs):  # noqa: E501
        """DeletedWorkspace - a model defined in OpenAPI
