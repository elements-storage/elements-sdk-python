...
class SearchEndpointResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'tapes': ([Tape],),  # noqa: E501
            'entries': ([TapeFile],),  # noqa: E501
            'total': (int,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tapes, entries, total, *args, **xkwargs):  # noqa: E501
        """SearchEndpointResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, tapes, entries, total, *args, **xkwargs):  # noqa: E501
        """SearchEndpointResponse - a model defined in OpenAPI
