...
class StoredSubtitleEvent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, t_in, t_out, text, subtitle, *args, **xkwargs):  # noqa: E501
        """StoredSubtitleEvent - a model defined in OpenAPI
        ...
        Args:
            ...
            t_out (float):
            text (str):
            subtitle (int): Subtitle asset this event belongs to
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, t_in, t_out, text, subtitle, *args, **xkwargs):  # noqa: E501
        """StoredSubtitleEvent - a model defined in OpenAPI
