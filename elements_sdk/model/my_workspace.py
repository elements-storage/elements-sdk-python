...
class MyWorkspace(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'endpoints': ([WorkspaceEndpoint],),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, production, volume, sharing_nfs_permissions, quota_size_hard, quota_size_soft, name, description, long_description, is_template, active, win_protocol, win_drive, linux_protocol, linux_mountpoint, share_name, share_nfs, share_afp, sharing_hidden, sharing_require_login, sharing_read_only, sharing_allow_execute, enable_quota, current_size, affinity, emulate_avid, emulate_capture, emulate_preopen, emulate_alternate_data_streams, emulate_recycle_bin, smb_extra_config, afp_extra_config, recycle_bin_exclude, is_external, external_mac_url, external_win_url, external_linux_url, allow_symlinks, rw_permission_priority, veto_dot_underscore, template, *args, **xkwargs):  # noqa: E501
        """MyWorkspace - a model defined in OpenAPI
