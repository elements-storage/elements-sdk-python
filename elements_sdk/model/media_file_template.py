...
class MediaFileTemplate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, file, name, *args, **xkwargs):  # noqa: E501
        """MediaFileTemplate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, file, name, *args, **xkwargs):  # noqa: E501
        """MediaFileTemplate - a model defined in OpenAPI
