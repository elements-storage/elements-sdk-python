...
class LocateProxiesEndpointResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, asset, sync_id, path, *args, **xkwargs):  # noqa: E501
        """LocateProxiesEndpointResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset, sync_id, path, *args, **xkwargs):  # noqa: E501
        """LocateProxiesEndpointResponse - a model defined in OpenAPI
