...
class AIModelInferenceResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'annotations': ([AICombinedInferenceResult],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, annotations, *args, **xkwargs):  # noqa: E501
        """AIModelInferenceResponse - a model defined in OpenAPI

        Args:
            annotations ([AICombinedInferenceResult]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, annotations, *args, **xkwargs):  # noqa: E501
        """AIModelInferenceResponse - a model defined in OpenAPI
