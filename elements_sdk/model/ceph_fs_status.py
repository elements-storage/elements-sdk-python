...
def lazy_import():
    ...
    globals()['CephMetadataServer'] = CephMetadataServer
    globals()['CephPool'] = CephPool


class CephFsStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'metadata_servers': ([CephMetadataServer],),  # noqa: E501
            'pools': ([CephPool],),  # noqa: E501
        }
    ...
    attribute_map = {
        'metadata_servers': 'metadata_servers',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, metadata_servers, pools, *args, **xkwargs):  # noqa: E501
        """CephFsStatus - a model defined in OpenAPI

        Args:
            metadata_servers ([CephMetadataServer]):
            pools ([CephPool]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, metadata_servers, pools, *args, **xkwargs):  # noqa: E501
        """CephFsStatus - a model defined in OpenAPI
