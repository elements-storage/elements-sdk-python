...
class QumuloIntegration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, known_addresses, name, address, username, password, address_override, *args, **xkwargs):  # noqa: E501
        """QumuloIntegration - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, known_addresses, name, address, username, password, address_override, *args, **xkwargs):  # noqa: E501
        """QumuloIntegration - a model defined in OpenAPI
