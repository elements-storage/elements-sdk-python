...
class PathPermissions(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, read, write, create, delete, update, *args, **xkwargs):  # noqa: E501
        """PathPermissions - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, read, write, create, delete, update, *args, **xkwargs):  # noqa: E501
        """PathPermissions - a model defined in OpenAPI
