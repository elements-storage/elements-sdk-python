...
class BeeGFSNode(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, host, roles, addresses, *args, **xkwargs):  # noqa: E501
        """BeeGFSNode - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, host, roles, addresses, *args, **xkwargs):  # noqa: E501
        """BeeGFSNode - a model defined in OpenAPI
