...
class TapeMini(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, uuid, generation, custom_a, custom_b, custom_c, custom_d, free_space, load_counter, error_counter, error_reason, active, lto, group, *args, **xkwargs):  # noqa: E501
        """TapeMini - a model defined in OpenAPI
