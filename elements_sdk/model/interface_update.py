...
class InterfaceUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, device, mac, *args, **xkwargs):  # noqa: E501
        """InterfaceUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, device, mac, *args, **xkwargs):  # noqa: E501
        """InterfaceUpdate - a model defined in OpenAPI
