...
class AIDatasetWithPreviewUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, connection, *args, **xkwargs):  # noqa: E501
        """AIDatasetWithPreviewUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, connection, *args, **xkwargs):  # noqa: E501
        """AIDatasetWithPreviewUpdate - a model defined in OpenAPI
