...
class PythonEnvironment(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, version, *args, **xkwargs):  # noqa: E501
        """PythonEnvironment - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, version, *args, **xkwargs):  # noqa: E501
        """PythonEnvironment - a model defined in OpenAPI
