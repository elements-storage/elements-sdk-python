...
class ProxyFSSizeEndpointResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, size, *args, **xkwargs):  # noqa: E501
        """ProxyFSSizeEndpointResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, size, *args, **xkwargs):  # noqa: E501
        """ProxyFSSizeEndpointResponse - a model defined in OpenAPI
