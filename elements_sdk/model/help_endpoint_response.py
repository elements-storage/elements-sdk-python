...
class HelpEndpointResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, page, *args, **xkwargs):  # noqa: E501
        """HelpEndpointResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, page, *args, **xkwargs):  # noqa: E501
        """HelpEndpointResponse - a model defined in OpenAPI
