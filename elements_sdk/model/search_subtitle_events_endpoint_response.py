...
def lazy_import():
    ...
    globals()['StoredSubtitleEvent'] = StoredSubtitleEvent


class SearchSubtitleEventsEndpointResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'subtitle_event': (StoredSubtitleEvent,),  # noqa: E501
    ...
    attribute_map = {
        'subtitle_event': 'subtitle_event',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, subtitle_event, asset, *args, **xkwargs):  # noqa: E501
        """SearchSubtitleEventsEndpointResponse - a model defined in OpenAPI

        Args:
            subtitle_event (StoredSubtitleEvent):
            asset (AssetMini):
        ...
        self.subtitle_event = subtitle_event
        self.asset = asset
    ...
    @convert_js_args_to_python_args
    def __init__(self, subtitle_event, asset, *args, **xkwargs):  # noqa: E501
        """SearchSubtitleEventsEndpointResponse - a model defined in OpenAPI
