...
class BasicFile(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, path, name, size, modification_time, total_size, is_dir, *args, **xkwargs):  # noqa: E501
        """BasicFile - a model defined in OpenAPI
