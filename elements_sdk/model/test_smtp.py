...
class TestSMTP(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, *args, **xkwargs):  # noqa: E501
        """TestSMTP - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, *args, **xkwargs):  # noqa: E501
        """TestSMTP - a model defined in OpenAPI
