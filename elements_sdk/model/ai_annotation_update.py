...
class AIAnnotationUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, image, category, relative_left, relative_top, relative_width, relative_height, *args, **xkwargs):  # noqa: E501
        """AIAnnotationUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, image, category, relative_left, relative_top, relative_width, relative_height, *args, **xkwargs):  # noqa: E501
        """AIAnnotationUpdate - a model defined in OpenAPI
