...
def lazy_import():
    ...
    globals()['TaskLogEntryData'] = TaskLogEntryData


class TaskLogEntry(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (TaskLogEntryData,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data, marker, timestamp, *args, **xkwargs):  # noqa: E501
        """TaskLogEntry - a model defined in OpenAPI

        Args:
            data (TaskLogEntryData):
            marker (int):
            timestamp (int):
    ...
    @convert_js_args_to_python_args
    def __init__(self, data, marker, timestamp, *args, **xkwargs):  # noqa: E501
        """TaskLogEntry - a model defined in OpenAPI
