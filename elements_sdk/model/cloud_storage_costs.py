...
class CloudStorageCosts(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'total': (CloudBucketCosts,),  # noqa: E501
            'volumes': ({str: (CloudBucketCosts,)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, total, volumes, *args, **xkwargs):  # noqa: E501
        """CloudStorageCosts - a model defined in OpenAPI

        Args:
            total (CloudBucketCosts):
            volumes ({str: (CloudBucketCosts,)}):
    ...
    @convert_js_args_to_python_args
    def __init__(self, total, volumes, *args, **xkwargs):  # noqa: E501
        """CloudStorageCosts - a model defined in OpenAPI
