...
class UpdatedFile(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'file': (FilesystemFile,),  # noqa: E501
            'tasks': ([TaskInfo],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, file, tasks, *args, **xkwargs):  # noqa: E501
        """UpdatedFile - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, file, tasks, *args, **xkwargs):  # noqa: E501
        """UpdatedFile - a model defined in OpenAPI
