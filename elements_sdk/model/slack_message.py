...
class SlackMessage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, recipient, text, *args, **xkwargs):  # noqa: E501
        """SlackMessage - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            emoji (str, none_type): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, recipient, text, *args, **xkwargs):  # noqa: E501
        """SlackMessage - a model defined in OpenAPI
