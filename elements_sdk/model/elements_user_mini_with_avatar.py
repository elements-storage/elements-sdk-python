...
class ElementsUserMiniWithAvatar(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, display_name, email, full_name, is_external, is_cloud, username, avatar, *args, **xkwargs):  # noqa: E501
        """ElementsUserMiniWithAvatar - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, email, full_name, is_external, is_cloud, username, *args, **xkwargs):  # noqa: E501
        """ElementsUserMiniWithAvatar - a model defined in OpenAPI
