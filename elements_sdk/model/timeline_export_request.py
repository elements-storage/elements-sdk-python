...
class TimelineExportRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, project, format, *args, **xkwargs):  # noqa: E501
        """TimelineExportRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, project, format, *args, **xkwargs):  # noqa: E501
        """TimelineExportRequest - a model defined in OpenAPI
