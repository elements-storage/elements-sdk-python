...
class ImportAIDatasetRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, connection, path, replace, *args, **xkwargs):  # noqa: E501
        """ImportAIDatasetRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, connection, path, replace, *args, **xkwargs):  # noqa: E501
        """ImportAIDatasetRequest - a model defined in OpenAPI
