...
class LDAPProbeRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, host, username, password, *args, **xkwargs):  # noqa: E501
        """LDAPProbeRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, host, username, password, *args, **xkwargs):  # noqa: E501
        """LDAPProbeRequest - a model defined in OpenAPI
