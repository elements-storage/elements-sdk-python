...
class RegisterUploadEndpointRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, upload_id, path, *args, **xkwargs):  # noqa: E501
        """RegisterUploadEndpointRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, upload_id, path, *args, **xkwargs):  # noqa: E501
        """RegisterUploadEndpointRequest - a model defined in OpenAPI
