...
class AssetBackupMini(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, tape_file, *args, **xkwargs):  # noqa: E501
        """AssetBackupMini - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, tape_file, *args, **xkwargs):  # noqa: E501
        """AssetBackupMini - a model defined in OpenAPI
