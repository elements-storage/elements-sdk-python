...
class MediaFileBundleMini(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'mainfile': (MediaFileMini,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, asset, name, location, mainfile, *args, **xkwargs):  # noqa: E501
        """MediaFileBundleMini - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, asset, name, location, mainfile, *args, **xkwargs):  # noqa: E501
        """MediaFileBundleMini - a model defined in OpenAPI
