...
class ExtractRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, stream, destination, *args, **xkwargs):  # noqa: E501
        """ExtractRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, stream, destination, *args, **xkwargs):  # noqa: E501
        """ExtractRequest - a model defined in OpenAPI
