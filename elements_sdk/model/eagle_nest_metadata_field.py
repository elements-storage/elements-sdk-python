...
class EagleNestMetadataField(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, type, *args, **xkwargs):  # noqa: E501
        """EagleNestMetadataField - a model defined in OpenAPI
        ...
        Keyword Args:
            origin (str): defaults to "default", must be one of ["default", "video", "audio", "manual", ]  # noqa: E501
        ...
        origin = xkwargs.get('origin', "default")
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, type, *args, **xkwargs):  # noqa: E501
        """EagleNestMetadataField - a model defined in OpenAPI
