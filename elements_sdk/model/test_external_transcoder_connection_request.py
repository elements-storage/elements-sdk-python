...
class TestExternalTranscoderConnectionRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, address, *args, **xkwargs):  # noqa: E501
        """TestExternalTranscoderConnectionRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, address, *args, **xkwargs):  # noqa: E501
        """TestExternalTranscoderConnectionRequest - a model defined in OpenAPI
