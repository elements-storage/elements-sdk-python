...
class DownloadArchiveUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, task_info, name, path, *args, **xkwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, task_info, name, path, *args, **xkwargs):  # noqa: E501
        """DownloadArchiveUpdate - a model defined in OpenAPI
