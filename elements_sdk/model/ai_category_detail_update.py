...
class AICategoryDetailUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dataset, name, *args, **xkwargs):  # noqa: E501
        """AICategoryDetailUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, dataset, name, *args, **xkwargs):  # noqa: E501
        """AICategoryDetailUpdate - a model defined in OpenAPI
