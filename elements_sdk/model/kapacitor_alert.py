...
class KapacitorAlert(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ({str: (str, none_type)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, level, message, details, data, *args, **xkwargs):  # noqa: E501
        """KapacitorAlert - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, level, message, details, data, *args, **xkwargs):  # noqa: E501
        """KapacitorAlert - a model defined in OpenAPI
