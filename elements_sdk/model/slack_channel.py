...
class SlackChannel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, is_private, *args, **xkwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, is_private, *args, **xkwargs):  # noqa: E501
        """SlackChannel - a model defined in OpenAPI
