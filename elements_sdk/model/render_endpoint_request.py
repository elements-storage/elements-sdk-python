...
class RenderEndpointRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'sequence': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'project': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'options': (SequenceRenderRequestOptions,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, sequence, project, options, *args, **xkwargs):  # noqa: E501
        """RenderEndpointRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, sequence, project, options, *args, **xkwargs):  # noqa: E501
        """RenderEndpointRequest - a model defined in OpenAPI
