...
class TapeGroup(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, tapes, name, *args, **xkwargs):  # noqa: E501
        """TapeGroup - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, tapes, name, *args, **xkwargs):  # noqa: E501
        """TapeGroup - a model defined in OpenAPI
