...
class GetMultipleFilesRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, files, *args, **xkwargs):  # noqa: E501
        """GetMultipleFilesRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, files, *args, **xkwargs):  # noqa: E501
        """GetMultipleFilesRequest - a model defined in OpenAPI
