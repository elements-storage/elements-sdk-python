...
class VantageWorkflows(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'workflows': ([VantageWorkflow],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, workflows, *args, **xkwargs):  # noqa: E501
        """VantageWorkflows - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, workflows, *args, **xkwargs):  # noqa: E501
        """VantageWorkflows - a model defined in OpenAPI
