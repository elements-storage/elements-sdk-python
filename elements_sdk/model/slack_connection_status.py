...
class SlackConnectionStatus(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ok, team, user, url, *args, **xkwargs):  # noqa: E501
        """SlackConnectionStatus - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, ok, team, user, url, *args, **xkwargs):  # noqa: E501
        """SlackConnectionStatus - a model defined in OpenAPI
