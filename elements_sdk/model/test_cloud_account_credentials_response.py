...
class TestCloudAccountCredentialsResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, subscriptions, *args, **xkwargs):  # noqa: E501
        """TestCloudAccountCredentialsResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, subscriptions, *args, **xkwargs):  # noqa: E501
        """TestCloudAccountCredentialsResponse - a model defined in OpenAPI
