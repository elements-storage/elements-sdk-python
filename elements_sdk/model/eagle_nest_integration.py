...
class EagleNestIntegration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, username, password, field_mappings, *args, **xkwargs):  # noqa: E501
        """EagleNestIntegration - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, username, password, field_mappings, *args, **xkwargs):  # noqa: E501
        """EagleNestIntegration - a model defined in OpenAPI
