...
class WorkspaceEndpoint(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, protocol, address, path, priority, platform, username, password, *args, **xkwargs):  # noqa: E501
        """WorkspaceEndpoint - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, protocol, address, path, priority, platform, username, password, *args, **xkwargs):  # noqa: E501
        """WorkspaceEndpoint - a model defined in OpenAPI
