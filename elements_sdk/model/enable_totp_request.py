...
class EnableTOTPRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, otp, *args, **xkwargs):  # noqa: E501
        """EnableTOTPRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, otp, *args, **xkwargs):  # noqa: E501
        """EnableTOTPRequest - a model defined in OpenAPI
