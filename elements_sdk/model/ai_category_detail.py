...
class AICategoryDetail(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, annotation_count, sample_annotation, connection, dataset, name, *args, **xkwargs):  # noqa: E501
        """AICategoryDetail - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, dataset, name, *args, **xkwargs):  # noqa: E501
        """AICategoryDetail - a model defined in OpenAPI
