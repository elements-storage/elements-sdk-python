...
class ShareToHomeWorkspaceEndpointRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user, name, *args, **xkwargs):  # noqa: E501
        """ShareToHomeWorkspaceEndpointRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user, name, *args, **xkwargs):  # noqa: E501
        """ShareToHomeWorkspaceEndpointRequest - a model defined in OpenAPI
