...
class AIDatasetDetail(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, last_change, name, type, connection, *args, **xkwargs):  # noqa: E501
        """AIDatasetDetail - a model defined in OpenAPI
