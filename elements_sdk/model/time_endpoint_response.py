...
class TimeEndpointResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time, timezone, timezones, *args, **xkwargs):  # noqa: E501
        """TimeEndpointResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, time, timezone, timezones, *args, **xkwargs):  # noqa: E501
        """TimeEndpointResponse - a model defined in OpenAPI
