...
class MediaRootPermissionMini(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, root, path, user, group, *args, **xkwargs):  # noqa: E501
        """MediaRootPermissionMini - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, root, path, user, group, *args, **xkwargs):  # noqa: E501
        """MediaRootPermissionMini - a model defined in OpenAPI
