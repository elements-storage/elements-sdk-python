...
class ExternalTranscoderUpdate(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'path_mappings': ([{str: (str, none_type)}],),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, path_mappings, name, address, *args, **xkwargs):  # noqa: E501
        """ExternalTranscoderUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, path_mappings, name, address, *args, **xkwargs):  # noqa: E501
        """ExternalTranscoderUpdate - a model defined in OpenAPI
