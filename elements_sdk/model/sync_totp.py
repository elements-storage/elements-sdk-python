...
class SyncTOTP(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, drift, *args, **xkwargs):  # noqa: E501
        """SyncTOTP - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, drift, *args, **xkwargs):  # noqa: E501
        """SyncTOTP - a model defined in OpenAPI
