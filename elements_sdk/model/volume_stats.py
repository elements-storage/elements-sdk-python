...
def lazy_import():
    ...
    globals()['VolumeStat'] = VolumeStat


class VolumeStats(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, usage, *args, **xkwargs):  # noqa: E501
        """VolumeStats - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, usage, *args, **xkwargs):  # noqa: E501
        """VolumeStats - a model defined in OpenAPI
