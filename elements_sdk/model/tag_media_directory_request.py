...
class TagMediaDirectoryRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tag, add, *args, **xkwargs):  # noqa: E501
        """TagMediaDirectoryRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, tag, add, *args, **xkwargs):  # noqa: E501
        """TagMediaDirectoryRequest - a model defined in OpenAPI
