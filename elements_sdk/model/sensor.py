...
class Sensor(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, value, unit, status, *args, **xkwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, value, unit, status, *args, **xkwargs):  # noqa: E501
        """Sensor - a model defined in OpenAPI
