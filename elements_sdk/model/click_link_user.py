...
class ClickLinkUser(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, username, email, display_name, *args, **xkwargs):  # noqa: E501
        """ClickLinkUser - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, username, email, display_name, *args, **xkwargs):  # noqa: E501
        """ClickLinkUser - a model defined in OpenAPI
