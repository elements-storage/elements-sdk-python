...
class PasswordResetEndpointRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, token, password, *args, **xkwargs):  # noqa: E501
        """PasswordResetEndpointRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, token, password, *args, **xkwargs):  # noqa: E501
        """PasswordResetEndpointRequest - a model defined in OpenAPI
