...
class VeritoneJobList(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'jobs': ([{str: (str, none_type)}],),  # noqa: E501
            'count': (int,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, jobs, count, *args, **xkwargs):  # noqa: E501
        """VeritoneJobList - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, jobs, count, *args, **xkwargs):  # noqa: E501
        """VeritoneJobList - a model defined in OpenAPI
