...
class VolumeStat(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time, c_total, c_used, *args, **xkwargs):  # noqa: E501
        """VolumeStat - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, time, c_total, c_used, *args, **xkwargs):  # noqa: E501
        """VolumeStat - a model defined in OpenAPI
