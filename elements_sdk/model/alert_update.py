...
class AlertUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, message, level, is_open, *args, **xkwargs):  # noqa: E501
        """AlertUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, message, level, is_open, *args, **xkwargs):  # noqa: E501
        """AlertUpdate - a model defined in OpenAPI
