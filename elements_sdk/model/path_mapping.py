...
class PathMapping(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, local, remote, *args, **xkwargs):  # noqa: E501
        """PathMapping - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, local, remote, *args, **xkwargs):  # noqa: E501
        """PathMapping - a model defined in OpenAPI
