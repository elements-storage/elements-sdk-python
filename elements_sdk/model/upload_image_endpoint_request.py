...
class UploadImageEndpointRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, data, *args, **xkwargs):  # noqa: E501
        """UploadImageEndpointRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, data, *args, **xkwargs):  # noqa: E501
        """UploadImageEndpointRequest - a model defined in OpenAPI
