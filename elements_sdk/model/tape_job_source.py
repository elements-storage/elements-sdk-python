...
class TapeJobSource(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'path': (str,),  # noqa: E501
            'options': ({str: (str, none_type)}, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, path, *args, **xkwargs):  # noqa: E501
        """TapeJobSource - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            options ({str: (str, none_type)}, none_type): [optional]  # noqa: E501
