...
class AIModelProgress(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'status': ({str: (str, none_type)},),  # noqa: E501
            'eta': (datetime, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, eta, *args, **xkwargs):  # noqa: E501
        """AIModelProgress - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, eta, *args, **xkwargs):  # noqa: E501
        """AIModelProgress - a model defined in OpenAPI
