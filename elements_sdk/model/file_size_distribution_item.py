...
class FileSizeDistributionItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, min, max, count, percent, average, total, *args, **xkwargs):  # noqa: E501
        """FileSizeDistributionItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, min, max, count, percent, average, total, *args, **xkwargs):  # noqa: E501
        """FileSizeDistributionItem - a model defined in OpenAPI
