...
class VeritoneEngineList(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'engines': ([{str: (str, none_type)}],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, engines, *args, **xkwargs):  # noqa: E501
        """VeritoneEngineList - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, engines, *args, **xkwargs):  # noqa: E501
        """VeritoneEngineList - a model defined in OpenAPI
