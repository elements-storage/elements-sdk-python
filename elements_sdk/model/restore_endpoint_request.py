...
class RestoreEndpointRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, source, exclude, tape, start_date, *args, **xkwargs):  # noqa: E501
        """RestoreEndpointRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, source, exclude, tape, start_date, *args, **xkwargs):  # noqa: E501
        """RestoreEndpointRequest - a model defined in OpenAPI
