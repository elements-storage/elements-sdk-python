...
class PhysicalFile(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, path, name, size, modification_time, is_dir, path_permissions, *args, **xkwargs):  # noqa: E501
        """PhysicalFile - a model defined in OpenAPI
