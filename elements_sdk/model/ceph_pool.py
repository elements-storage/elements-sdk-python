...
class CephPool(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, available, used, name, type, *args, **xkwargs):  # noqa: E501
        """CephPool - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, available, used, name, type, *args, **xkwargs):  # noqa: E501
        """CephPool - a model defined in OpenAPI
