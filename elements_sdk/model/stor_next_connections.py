...
class StorNextConnections(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, list, normal, proxy, gateway, *args, **xkwargs):  # noqa: E501
        """StorNextConnections - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, list, normal, proxy, gateway, *args, **xkwargs):  # noqa: E501
        """StorNextConnections - a model defined in OpenAPI
