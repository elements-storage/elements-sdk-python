...
class ClickStartUploadEndpointRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, connection, assets, *args, **xkwargs):  # noqa: E501
        """ClickStartUploadEndpointRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, connection, assets, *args, **xkwargs):  # noqa: E501
        """ClickStartUploadEndpointRequest - a model defined in OpenAPI
