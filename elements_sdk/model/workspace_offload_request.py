...
class WorkspaceOffloadRequest(ModelNormal):
    ...
    attribute_map = {
        ...
        'user': 'user',  # noqa: E501
        'is_retrieval': 'is_retrieval',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, workspace, user, is_retrieval, created_at, *args, **xkwargs):  # noqa: E501
        """WorkspaceOffloadRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, workspace, user, is_retrieval, *args, **xkwargs):  # noqa: E501
        """WorkspaceOffloadRequest - a model defined in OpenAPI
