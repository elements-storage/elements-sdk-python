...
class CloudAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, provider, access_id, secret, tenant, subscription, endpoint, enabled, mount_credentials_management, *args, **xkwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, provider, access_id, secret, tenant, subscription, endpoint, enabled, mount_credentials_management, *args, **xkwargs):  # noqa: E501
        """CloudAccount - a model defined in OpenAPI
