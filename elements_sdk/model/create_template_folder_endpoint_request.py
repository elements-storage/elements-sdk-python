...
class CreateTemplateFolderEndpointRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, template, path, *args, **xkwargs):  # noqa: E501
        """CreateTemplateFolderEndpointRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, template, path, *args, **xkwargs):  # noqa: E501
        """CreateTemplateFolderEndpointRequest - a model defined in OpenAPI
