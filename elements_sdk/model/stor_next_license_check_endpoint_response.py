...
class StorNextLicenseCheckEndpointResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, mac, key, type, comment, valid, *args, **xkwargs):  # noqa: E501
        """StorNextLicenseCheckEndpointResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, mac, key, type, comment, valid, *args, **xkwargs):  # noqa: E501
        """StorNextLicenseCheckEndpointResponse - a model defined in OpenAPI
