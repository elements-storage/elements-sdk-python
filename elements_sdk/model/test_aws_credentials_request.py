...
class TestAWSCredentialsRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, access_key_id, secret_access_key, *args, **xkwargs):  # noqa: E501
        """TestAWSCredentialsRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, access_key_id, secret_access_key, *args, **xkwargs):  # noqa: E501
        """TestAWSCredentialsRequest - a model defined in OpenAPI
