...
class QueuedTaskInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, task_info, id, task_name, *args, **xkwargs):  # noqa: E501
        """QueuedTaskInfo - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, task_info, id, task_name, *args, **xkwargs):  # noqa: E501
        """QueuedTaskInfo - a model defined in OpenAPI
