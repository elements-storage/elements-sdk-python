...
class MediaPinnedItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, bookmarked_file, saved_search, pin_order, *args, **xkwargs):  # noqa: E501
        """MediaPinnedItem - a model defined in OpenAPI
        ...
        self.id = id
        self.bookmarked_file = bookmarked_file
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, bookmarked_file, saved_search, pin_order, *args, **xkwargs):  # noqa: E501
        """MediaPinnedItem - a model defined in OpenAPI
