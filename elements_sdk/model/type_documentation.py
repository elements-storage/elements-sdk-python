...
class TypeDocumentation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, url, *args, **xkwargs):  # noqa: E501
        """TypeDocumentation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, url, *args, **xkwargs):  # noqa: E501
        """TypeDocumentation - a model defined in OpenAPI
