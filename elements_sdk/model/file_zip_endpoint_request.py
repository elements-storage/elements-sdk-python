...
class FileZipEndpointRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, input, path, name, *args, **xkwargs):  # noqa: E501
        """FileZipEndpointRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, input, path, name, *args, **xkwargs):  # noqa: E501
        """FileZipEndpointRequest - a model defined in OpenAPI
