...
class EditorMarker(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, start, end, title, text, color, *args, **xkwargs):  # noqa: E501
        """EditorMarker - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, text, color, *args, **xkwargs):  # noqa: E501
        """EditorMarker - a model defined in OpenAPI
