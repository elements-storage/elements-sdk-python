...
class BeeGFSTarget(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, host, storage_pool, size_total, size_used, size_free, online, consistent, errors, *args, **xkwargs):  # noqa: E501
        """BeeGFSTarget - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, host, storage_pool, size_total, size_used, size_free, online, consistent, errors, *args, **xkwargs):  # noqa: E501
        """BeeGFSTarget - a model defined in OpenAPI
