...
class UnfilteredTagUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, roots, name, *args, **xkwargs):  # noqa: E501
        """UnfilteredTagUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, roots, name, *args, **xkwargs):  # noqa: E501
        """UnfilteredTagUpdate - a model defined in OpenAPI
