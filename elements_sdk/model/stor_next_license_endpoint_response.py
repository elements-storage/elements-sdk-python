...
class StorNextLicenseEndpointResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, expiry, capacity, *args, **xkwargs):  # noqa: E501
        """StorNextLicenseEndpointResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, expiry, capacity, *args, **xkwargs):  # noqa: E501
        """StorNextLicenseEndpointResponse - a model defined in OpenAPI
