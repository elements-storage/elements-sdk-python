...
class TaskLogV2(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'entries': ([TaskLogEntry],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, entries, *args, **xkwargs):  # noqa: E501
        """TaskLogV2 - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, entries, *args, **xkwargs):  # noqa: E501
        """TaskLogV2 - a model defined in OpenAPI
