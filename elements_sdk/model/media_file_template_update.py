...
class MediaFileTemplateUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, file, name, *args, **xkwargs):  # noqa: E501
        """MediaFileTemplateUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, file, name, *args, **xkwargs):  # noqa: E501
        """MediaFileTemplateUpdate - a model defined in OpenAPI
