...
class TaskInfoMini(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'subtask': (int, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, task_name, state, finished, subtask, display_name, *args, **xkwargs):  # noqa: E501
        """TaskInfoMini - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, task_name, state, subtask, *args, **xkwargs):  # noqa: E501
        """TaskInfoMini - a model defined in OpenAPI
