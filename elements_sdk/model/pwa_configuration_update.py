...
class PWAConfigurationUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, enable, name, *args, **xkwargs):  # noqa: E501
        """PWAConfigurationUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, enable, name, *args, **xkwargs):  # noqa: E501
        """PWAConfigurationUpdate - a model defined in OpenAPI
