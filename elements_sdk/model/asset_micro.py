...
class AssetMicro(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'format': (FormatMetadataMini,),  # noqa: E501
    ...
    def _from_openapi_data(cls, id, sync_id, display_name, format, thumbnail_generated, *args, **xkwargs):  # noqa: E501
        """AssetMicro - a model defined in OpenAPI

        Args:
            id (int):
            sync_id (str):
            display_name (str):
            format (FormatMetadataMini):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, format, *args, **xkwargs):  # noqa: E501
        """AssetMicro - a model defined in OpenAPI
