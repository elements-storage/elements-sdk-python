...
class SearchMarkersEndpointResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, marker, asset, *args, **xkwargs):  # noqa: E501
        """SearchMarkersEndpointResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, marker, asset, *args, **xkwargs):  # noqa: E501
        """SearchMarkersEndpointResponse - a model defined in OpenAPI
