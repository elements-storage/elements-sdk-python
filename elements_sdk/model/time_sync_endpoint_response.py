...
class TimeSyncEndpointResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, output, *args, **xkwargs):  # noqa: E501
        """TimeSyncEndpointResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, output, *args, **xkwargs):  # noqa: E501
        """TimeSyncEndpointResponse - a model defined in OpenAPI
