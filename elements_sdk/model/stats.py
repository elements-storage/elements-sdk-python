...
class Stats(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'cpu': ([CPUStat],),  # noqa: E501
            'ram': ([RAMStat],),  # noqa: E501
            'net': ({str: ([NetStat],)},),  # noqa: E501
            'io': ([IOStat],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cpu, ram, net, io, *args, **xkwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, cpu, ram, net, io, *args, **xkwargs):  # noqa: E501
        """Stats - a model defined in OpenAPI
