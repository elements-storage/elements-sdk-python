...
class StartTaskRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, task_type, parameters, *args, **xkwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            sync (bool): [optional] if omitted the server will use the default value of False  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, task_type, parameters, *args, **xkwargs):  # noqa: E501
        """StartTaskRequest - a model defined in OpenAPI
