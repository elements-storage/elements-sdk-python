...
class LocateMarkersEndpointResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, markers, path, *args, **xkwargs):  # noqa: E501
        """LocateMarkersEndpointResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, markers, path, *args, **xkwargs):  # noqa: E501
        """LocateMarkersEndpointResponse - a model defined in OpenAPI
