...
class InstantiateFileTemplateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, parent, name, *args, **xkwargs):  # noqa: E501
        """InstantiateFileTemplateRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, parent, name, *args, **xkwargs):  # noqa: E501
        """InstantiateFileTemplateRequest - a model defined in OpenAPI
