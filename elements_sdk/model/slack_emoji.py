...
class SlackEmoji(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, url, name, *args, **xkwargs):  # noqa: E501
        """SlackEmoji - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, url, name, *args, **xkwargs):  # noqa: E501
        """SlackEmoji - a model defined in OpenAPI
