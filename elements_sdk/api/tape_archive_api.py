...
class TapeArchiveApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.cancel_tape_archive_job_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'Bearer'
                ],
                'endpoint_path': '/api/2/archive/tape/jobs/{id}/cancel',
                'operation_id': 'cancel_tape_archive_job',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.download_tape_archive_job_log_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'Bearer'
                ],
                'endpoint_path': '/api/2/archive/tape/jobs/{id}/log',
                'operation_id': 'download_tape_archive_job_log',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def cancel_tape_archive_job(
        self,
        id,
        **kwargs
    ):
        """cancel_tape_archive_job  # noqa: E501

        ### Required permissions    * User account permission: `None` (read) / `ltfs:manage` (write)   * License component: ltfs   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.cancel_tape_archive_job(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.cancel_tape_archive_job_endpoint.call_with_http_info(**kwargs)
    ...
    def download_tape_archive_job_log(
        self,
        id,
        **kwargs
    ):
        """download_tape_archive_job_log  # noqa: E501

        ### Required permissions    * User account permission: `None` (read) / `ltfs:manage` (write)   * License component: ltfs   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.download_tape_archive_job_log(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.download_tape_archive_job_log_endpoint.call_with_http_info(**kwargs)
