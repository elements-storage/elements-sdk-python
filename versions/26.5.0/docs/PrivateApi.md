...
------------- | ------------- | -------------
[**check_pmr**](PrivateApi.md#check_pmr) | **POST** `/api/2/panel/check-pmr` | 
...
[**get_licensing_state**](PrivateApi.md#get_licensing_state) | **POST** `/api/2/private/licensing-state` | 
...
[**locate_metadata**](PrivateApi.md#locate_metadata) | **POST** `/api/2/panel/locate-metadata` | 
...
# **check_pmr**
    def CheckPMREndpointResponse check_pmr(check_pmr_endpoint_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.check_pmr(check_pmr_endpoint_request)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling PrivateApi->check_pmr: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **check_pmr_endpoint_request** | [**CheckPMREndpointRequest**](CheckPMREndpointRequest.md)|  |

### Return type

[**CheckPMREndpointResponse**](CheckPMREndpointResponse.md)
...
# **get_licensing_state**
    def LicensingStateEndpointResponse get_licensing_state()
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example, this endpoint has no required or optional parameters
    try:
        api_response = api_instance.get_licensing_state()
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling PrivateApi->get_licensing_state: %s\n" % e)
```
...
[**LicensingStateEndpointResponse**](LicensingStateEndpointResponse.md)
...
# **locate_metadata**
    def [LocateMetadataEndpointResponse] locate_metadata(locate_metadata_endpoint_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.locate_metadata(locate_metadata_endpoint_request)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling PrivateApi->locate_metadata: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **locate_metadata_endpoint_request** | [**LocateMetadataEndpointRequest**](LocateMetadataEndpointRequest.md)|  |

### Return type

[**[LocateMetadataEndpointResponse]**](LocateMetadataEndpointResponse.md)
