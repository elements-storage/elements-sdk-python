...
[**browse_storage_restore_request**](MediaLibraryApi.md#browse_storage_restore_request) | **GET** `/api/2/media/storage-restore-requests/{id}/browse` | 
[**change_storage_class**](MediaLibraryApi.md#change_storage_class) | **POST** `/api/2/media/files/{id}/change-storage-class` | 
...
[**create_eagle_nest_integration**](MediaLibraryApi.md#create_eagle_nest_integration) | **POST** `/api/2/media/eaglenest-integrations` | 
...
[**delete_eagle_nest_integration**](MediaLibraryApi.md#delete_eagle_nest_integration) | **DELETE** `/api/2/media/eaglenest-integrations/{id}` | 
...
[**editor_export_aaf_for_project**](MediaLibraryApi.md#editor_export_aaf_for_project) | **GET** `/api/2/media/editor/{id}/aaf-export` | 
[**editor_export_xml_for_asset**](MediaLibraryApi.md#editor_export_xml_for_asset) | **GET** `/api/2/media/editor/asset/{asset_ids}/xml-export` | 
...
[**get_all_eagle_nest_integrations**](MediaLibraryApi.md#get_all_eagle_nest_integrations) | **GET** `/api/2/media/eaglenest-integrations` | 
[**get_all_eagle_nest_metadata_fields**](MediaLibraryApi.md#get_all_eagle_nest_metadata_fields) | **GET** `/api/2/media/eaglenest-integrations/metadata-fields` | 
...
[**get_all_storage_restore_requests**](MediaLibraryApi.md#get_all_storage_restore_requests) | **GET** `/api/2/media/storage-restore-requests` | 
...
[**get_eagle_nest_integration**](MediaLibraryApi.md#get_eagle_nest_integration) | **GET** `/api/2/media/eaglenest-integrations/{id}` | 
[**get_eagle_nest_projects**](MediaLibraryApi.md#get_eagle_nest_projects) | **GET** `/api/2/media/eaglenest-integrations/{id}/projects` | 
...
[**get_media_file_by_path**](MediaLibraryApi.md#get_media_file_by_path) | **POST** `/api/2/media/files/path` | 
...
[**get_storage_restore_request**](MediaLibraryApi.md#get_storage_restore_request) | **GET** `/api/2/media/storage-restore-requests/{id}` | 
[**get_subtitle_event**](MediaLibraryApi.md#get_subtitle_event) | **GET** `/api/2/media/subtitle-events/{id}` | 
...
[**patch_eagle_nest_integration**](MediaLibraryApi.md#patch_eagle_nest_integration) | **PATCH** `/api/2/media/eaglenest-integrations/{id}` | 
...
[**refresh_storage_restore_request**](MediaLibraryApi.md#refresh_storage_restore_request) | **POST** `/api/2/media/storage-restore-requests/{id}/refresh` | 
[**refresh_storage_restore_status**](MediaLibraryApi.md#refresh_storage_restore_status) | **POST** `/api/2/media/files/{id}/refresh-storage-restore-status` | 
...
[**request_storage_restore**](MediaLibraryApi.md#request_storage_restore) | **POST** `/api/2/media/files/{id}/request-storage-restore` | 
[**resolve_comment**](MediaLibraryApi.md#resolve_comment) | **POST** `/api/2/media/comments/{id}/resolve` | 
[**search_markers**](MediaLibraryApi.md#search_markers) | **POST** `/api/2/media/markers/search` | 
[**search_subclips**](MediaLibraryApi.md#search_subclips) | **POST** `/api/2/media/subclips/search` | 
[**search_subtitle_events**](MediaLibraryApi.md#search_subtitle_events) | **POST** `/api/2/media/subtitle-events/search` | 
...
[**update_eagle_nest_integration**](MediaLibraryApi.md#update_eagle_nest_integration) | **PUT** `/api/2/media/eaglenest-integrations/{id}` | 
...
# **browse_storage_restore_request**
    def [StorageRestoreRequestBrowseEntry] browse_storage_restore_request(id)



### Required permissions    * User account permission: `tasks:view`   * License component: universal 
...
with elements_sdk.ApiClient(configuration) as api_client:
    api_instance = media_library_api.MediaLibraryApi(api_client)
    id = 1 # int | A unique integer value identifying this Storage Restore Request.
    path = "path_example" # str |  (optional)
    limit = 1 # int |  (optional)
    offset = 1 # int |  (optional)
    filter = "filter_example" # str |  (optional)
    include_failed = True # bool |  (optional)
    include_expired = True # bool |  (optional)

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.browse_storage_restore_request(id)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->browse_storage_restore_request: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.browse_storage_restore_request(id, path=path, limit=limit, offset=offset, filter=filter, include_failed=include_failed, include_expired=include_expired)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->browse_storage_restore_request: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **int**| A unique integer value identifying this Storage Restore Request. |
 **path** | **str**|  | [optional]
 **limit** | **int**|  | [optional]
 **offset** | **int**|  | [optional]
 **filter** | **str**|  | [optional]
...
[**[StorageRestoreRequestBrowseEntry]**](StorageRestoreRequestBrowseEntry.md)

[[Back to top]](#) [[Back to API list]](../#documentation-for-api-endpoints) [[Back to Model list]](../#documentation-for-models) [[Back to README]](../)

# **change_storage_class**
    def TaskInfo change_storage_class(id, change_storage_class_request)



### Required permissions    * User account permission: `media:access`   * License component: media   * allow_write_db Media Library permissions   * License component: universal 
...
with elements_sdk.ApiClient(configuration) as api_client:
    api_instance = media_library_api.MediaLibraryApi(api_client)
    id = 1 # int | A unique integer value identifying this File.
    change_storage_class_request = ChangeStorageClassRequest(
        target_class="target_class_example",
        force_restore=False,
        restore_tier="restore_tier_example",
    ) # ChangeStorageClassRequest | 

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.change_storage_class(id, change_storage_class_request)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->change_storage_class: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| A unique integer value identifying this File. |
 **change_storage_class_request** | [**ChangeStorageClassRequest**](ChangeStorageClassRequest.md)|  |
...
# **create_eagle_nest_integration**
    def EagleNestIntegration create_eagle_nest_integration(eagle_nest_integration_update)
...
with elements_sdk.ApiClient(configuration) as api_client:
    api_instance = media_library_api.MediaLibraryApi(api_client)
    eagle_nest_integration_update = EagleNestIntegrationUpdate(
        name="name_example",
        username="username_example",
        password="password_example",
        field_mappings=[
            EagleNestFieldMapping(
                en_field=1,
                custom_field=1,
            ),
        ],
    ) # EagleNestIntegrationUpdate | 

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.create_eagle_nest_integration(eagle_nest_integration_update)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->create_eagle_nest_integration: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **eagle_nest_integration_update** | [**EagleNestIntegrationUpdate**](EagleNestIntegrationUpdate.md)|  |

### Return type

[**EagleNestIntegration**](EagleNestIntegration.md)
        ...
        volume=VolumeReference(
            ...
            backend=Backend(
                ...
                properties=BackendProperties(
                    ...
                    sharing_permissions_priority="rw",
                ),
            ),
            status=VolumeStatus(
                online=True,
                usage=VolumeUsage(
                    used_bytes=1,
                    total_bytes=1,
                    high_watermark_ratio=3.14,
                    critical_watermark_ratio=3.14,
                ),
...
# **delete_eagle_nest_integration**
    def delete_eagle_nest_integration(id)
...
with elements_sdk.ApiClient(configuration) as api_client:
    api_instance = media_library_api.MediaLibraryApi(api_client)
    id = 1 # int | A unique integer value identifying this eagle nest integration.

    # example passing only required values which don't have defaults set
    try:
        api_instance.delete_eagle_nest_integration(id)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->delete_eagle_nest_integration: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **int**| A unique integer value identifying this eagle nest integration. |
...
# **editor_export_aaf_for_project**
    def editor_export_aaf_for_project(id)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_instance.editor_export_aaf_for_project(id)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->editor_export_aaf_for_project: %s\n" % e)
```
...
# **editor_export_xml_for_asset**
    def XMLExport editor_export_xml_for_asset(asset_ids)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.editor_export_xml_for_asset(asset_ids)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->editor_export_xml_for_asset: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.editor_export_xml_for_asset(asset_ids, ordering=ordering, limit=limit, offset=offset, uri=uri)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->editor_export_xml_for_asset: %s\n" % e)
```
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.get_all_comments(asset=asset, root=root, user=user, ordering=ordering, cursor=cursor, limit=limit, offset=offset, for_root=for_root, tasks_for_user=tasks_for_user, include_full_asset=include_full_asset, advanced_search=advanced_search, in_directory=in_directory, filter=filter)
        pprint(api_response)
    except elements_sdk.ApiException as e:
...
# **get_all_eagle_nest_integrations**
    def [EagleNestIntegration] get_all_eagle_nest_integrations()
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.get_all_eagle_nest_integrations(ordering=ordering, limit=limit, offset=offset)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->get_all_eagle_nest_integrations: %s\n" % e)
```
...
# **get_all_eagle_nest_metadata_fields**
    def [EagleNestMetadataField] get_all_eagle_nest_metadata_fields()
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.get_all_eagle_nest_metadata_fields(ordering=ordering, limit=limit, offset=offset)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->get_all_eagle_nest_metadata_fields: %s\n" % e)
```
...
[**[EagleNestMetadataField]**](EagleNestMetadataField.md)
...
# **get_all_storage_restore_requests**
    def [StorageRestoreRequest] get_all_storage_restore_requests()
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    sort = "last-polled" # str |  (optional) if omitted the server will use the default value of "last-polled"

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.get_all_storage_restore_requests(ordering=ordering, limit=limit, offset=offset, status=status, filter=filter, filtering_mode=filtering_mode, sort=sort)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->get_all_storage_restore_requests: %s\n" % e)
```
 ...
 **sort** | **str**|  | [optional] if omitted the server will use the default value of "last-polled"

### Return type

[**[StorageRestoreRequest]**](StorageRestoreRequest.md)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.get_comment(id, for_root=for_root, tasks_for_user=tasks_for_user, include_full_asset=include_full_asset, advanced_search=advanced_search, in_directory=in_directory, filter=filter)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->get_comment: %s\n" % e)
```
...
# **get_eagle_nest_integration**
    def EagleNestIntegration get_eagle_nest_integration(id)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.get_eagle_nest_integration(id)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->get_eagle_nest_integration: %s\n" % e)
```
...
# **get_eagle_nest_projects**
    def [EagleNestProjectRef] get_eagle_nest_projects(id)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.get_eagle_nest_projects(id)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->get_eagle_nest_projects: %s\n" % e)
```
...
[**[EagleNestProjectRef]**](EagleNestProjectRef.md)
...
# **get_media_file_by_path**
    def MediaFile get_media_file_by_path(get_media_file_by_path_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.get_media_file_by_path(get_media_file_by_path_request)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->get_media_file_by_path: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **get_media_file_by_path_request** | [**GetMediaFileByPathRequest**](GetMediaFileByPathRequest.md)|  |
...
# **get_storage_restore_request**
    def StorageRestoreRequest get_storage_restore_request(id)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.get_storage_restore_request(id)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->get_storage_restore_request: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.get_storage_restore_request(id, include_root=include_root)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->get_storage_restore_request: %s\n" % e)
```
...
# **get_subtitle_event**
    def StoredSubtitleEvent get_subtitle_event(id)
...
with elements_sdk.ApiClient(configuration) as api_client:
    api_instance = media_library_api.MediaLibraryApi(api_client)
    id = 1 # int | A unique integer value identifying this subtitle event.

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.get_subtitle_event(id)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->get_subtitle_event: %s\n" % e)
```
...
[**StoredSubtitleEvent**](StoredSubtitleEvent.md)
...
# **patch_eagle_nest_integration**
    def EagleNestIntegration patch_eagle_nest_integration(id, eagle_nest_integration_partial_update)
...
with elements_sdk.ApiClient(configuration) as api_client:
    api_instance = media_library_api.MediaLibraryApi(api_client)
    id = 1 # int | A unique integer value identifying this eagle nest integration.
    eagle_nest_integration_partial_update = EagleNestIntegrationPartialUpdate(
        name="name_example",
        username="username_example",
        password="password_example",
        field_mappings=[
    ...
    ) # EagleNestIntegrationPartialUpdate | 

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_eagle_nest_integration(id, eagle_nest_integration_partial_update)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->patch_eagle_nest_integration: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| A unique integer value identifying this eagle nest integration. |
 **eagle_nest_integration_partial_update** | [**EagleNestIntegrationPartialUpdate**](EagleNestIntegrationPartialUpdate.md)|  |
...
# **refresh_storage_restore_request**
    def TaskInfo refresh_storage_restore_request(id)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.refresh_storage_restore_request(id)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->refresh_storage_restore_request: %s\n" % e)
```
...
# **refresh_storage_restore_status**
    def TaskInfo refresh_storage_restore_status(id)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.refresh_storage_restore_status(id)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->refresh_storage_restore_status: %s\n" % e)
```
...
# **request_storage_restore**
    def TaskInfo request_storage_restore(id, storage_restore_request_detail)
...
with elements_sdk.ApiClient(configuration) as api_client:
    api_instance = media_library_api.MediaLibraryApi(api_client)
    id = 1 # int | A unique integer value identifying this File.
    storage_restore_request_detail = StorageRestoreRequestDetail(
        restore_tier="restore_tier_example",
        restore_type="MAKE_AVAILABLE",
        target_path="target_path_example",
        days=1,
    ) # StorageRestoreRequestDetail | 

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.request_storage_restore(id, storage_restore_request_detail)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->request_storage_restore: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| A unique integer value identifying this File. |
 **storage_restore_request_detail** | [**StorageRestoreRequestDetail**](StorageRestoreRequestDetail.md)|  |
...
# **search_markers**
    def [SearchMarkersEndpointResponse] search_markers(search_markers_endpoint_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.search_markers(search_markers_endpoint_request)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->search_markers: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.search_markers(search_markers_endpoint_request, offset=offset, limit=limit)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->search_markers: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **search_markers_endpoint_request** | [**SearchMarkersEndpointRequest**](SearchMarkersEndpointRequest.md)|  |
 **offset** | **int**|  | [optional]
 **limit** | **int**|  | [optional]

### Return type

[**[SearchMarkersEndpointResponse]**](SearchMarkersEndpointResponse.md)

[[Back to top]](#) [[Back to API list]](../#documentation-for-api-endpoints) [[Back to Model list]](../#documentation-for-models) [[Back to README]](../)

# **search_subclips**
    def [Subclip] search_subclips(search_subclips_endpoint_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.search_subclips(search_subclips_endpoint_request)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->search_subclips: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.search_subclips(search_subclips_endpoint_request, offset=offset, limit=limit)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->search_subclips: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **search_subclips_endpoint_request** | [**SearchSubclipsEndpointRequest**](SearchSubclipsEndpointRequest.md)|  |
 **offset** | **int**|  | [optional]
 **limit** | **int**|  | [optional]
...
# **search_subtitle_events**
    def [SearchSubtitleEventsEndpointResponse] search_subtitle_events(search_subtitle_events_endpoint_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.search_subtitle_events(search_subtitle_events_endpoint_request)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->search_subtitle_events: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.search_subtitle_events(search_subtitle_events_endpoint_request, offset=offset, limit=limit)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->search_subtitle_events: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **search_subtitle_events_endpoint_request** | [**SearchSubtitleEventsEndpointRequest**](SearchSubtitleEventsEndpointRequest.md)|  |
 **offset** | **int**|  | [optional]
 **limit** | **int**|  | [optional]

### Return type

[**[SearchSubtitleEventsEndpointResponse]**](SearchSubtitleEventsEndpointResponse.md)
...
# **update_eagle_nest_integration**
    def EagleNestIntegration update_eagle_nest_integration(id, eagle_nest_integration_update)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_eagle_nest_integration(id, eagle_nest_integration_update)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MediaLibraryApi->update_eagle_nest_integration: %s\n" % e)
```
