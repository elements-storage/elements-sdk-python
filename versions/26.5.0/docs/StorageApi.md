...
------------- | ------------- | -------------
[**accept_workspace_offload_request**](StorageApi.md#accept_workspace_offload_request) | **POST** `/api/2/workspace-offload-requests/{id}/accept` | 
...
[**delete_workspace_offload_request**](StorageApi.md#delete_workspace_offload_request) | **DELETE** `/api/2/workspace-offload-requests/{id}` | 
...
[**get_all_workspace_offload_requests**](StorageApi.md#get_all_workspace_offload_requests) | **GET** `/api/2/workspace-offload-requests` | 
...
[**get_workspace_offload_request**](StorageApi.md#get_workspace_offload_request) | **GET** `/api/2/workspace-offload-requests/{id}` | 
[**get_workspace_permission**](StorageApi.md#get_workspace_permission) | **GET** `/api/2/workspace-permissions/{id}` | 
[**get_workspace_sync_to_offload_location_job**](StorageApi.md#get_workspace_sync_to_offload_location_job) | **GET** `/api/2/workspaces/{id}/sync-to-offload-location-job` | 
...
[**offload_workspace**](StorageApi.md#offload_workspace) | **POST** `/api/2/workspaces/{id}/offload` | 
...
[**request_workspace_offload**](StorageApi.md#request_workspace_offload) | **POST** `/api/2/workspaces/{id}/request-offload` | 
[**request_workspace_retrieval**](StorageApi.md#request_workspace_retrieval) | **POST** `/api/2/workspaces/{id}/request-retrieval` | 
[**retrieve_offloaded_workspace**](StorageApi.md#retrieve_offloaded_workspace) | **POST** `/api/2/workspaces/{id}/offload-retrieve` | 
[**setup_workspace_offload**](StorageApi.md#setup_workspace_offload) | **POST** `/api/2/workspaces/{id}/setup-offload` | 
[**share_to_home_workspace**](StorageApi.md#share_to_home_workspace) | **POST** `/api/2/share-to-home-workspace` | 
[**sync_workspace_to_offload_location**](StorageApi.md#sync_workspace_to_offload_location) | **POST** `/api/2/workspaces/{id}/sync-to-offload-location` | 
...
# **accept_workspace_offload_request**
    def TaskInfo accept_workspace_offload_request(id, base_transfer_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    id = 1 # int | A unique integer value identifying this workspace offload request.
    ...
    try:
        api_response = api_instance.accept_workspace_offload_request(id, base_transfer_request)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling StorageApi->accept_workspace_offload_request: %s\n" % e)
```
 ...
 **base_transfer_request** | [**BaseTransferRequest**](BaseTransferRequest.md)|  |
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    workspace_detail_update = WorkspaceDetailUpdate(
        ...
        enable_quota=True,
        current_size=-9223372036854775000,
        affinity="affinity_example",
        emulate_avid=True,
...
# **delete_workspace_offload_request**
    def delete_workspace_offload_request(id)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_instance.delete_workspace_offload_request(id)
    except elements_sdk.ApiException as e:
        print("Exception when calling StorageApi->delete_workspace_offload_request: %s\n" % e)
```
...
# **get_all_workspace_offload_requests**
    def [WorkspaceOffloadRequest] get_all_workspace_offload_requests()
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.get_all_workspace_offload_requests(ordering=ordering, limit=limit, offset=offset)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling StorageApi->get_all_workspace_offload_requests: %s\n" % e)
```
...
[**[WorkspaceOffloadRequest]**](WorkspaceOffloadRequest.md)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    offloadable = True # bool |  (optional)
    filter = "filter_example" # str |  (optional)
    filtering_mode = "exact" # str |  (optional)
    ...
    # and optional values
    try:
        api_response = api_instance.get_all_workspaces(is_template=is_template, production=production, volume=volume, home_for=home_for, volume__type=volume__type, production__name=production__name, production__active=production__active, name=name, is_external=is_external, active=active, ordering=ordering, limit=limit, offset=offset, full_path=full_path, resolve_access_for=resolve_access_for, include_quotas=include_quotas, offloadable=offloadable, filter=filter, filtering_mode=filtering_mode, sort=sort)
        pprint(api_response)
    except elements_sdk.ApiException as e:
...
# **get_my_workspaces**
    def [MyWorkspace] get_my_workspaces()
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.get_my_workspaces(is_template=is_template, production=production, volume=volume, home_for=home_for, volume__type=volume__type, production__name=production__name, production__active=production__active, name=name, is_external=is_external, active=active, ordering=ordering, limit=limit, offset=offset, full_path=full_path, include_quotas=include_quotas, offloadable=offloadable, filter=filter, filtering_mode=filtering_mode, sort=sort)
        pprint(api_response)
    except elements_sdk.ApiException as e:
...
# **get_workspace_offload_request**
    def WorkspaceOffloadRequest get_workspace_offload_request(id)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.get_workspace_offload_request(id)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling StorageApi->get_workspace_offload_request: %s\n" % e)
```
...
# **get_workspace_sync_to_offload_location_job**
    def Job get_workspace_sync_to_offload_location_job(id)



### Required permissions    * User account permission: `projects:manage` AND User account permission: `tasks:view` 
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.get_workspace_sync_to_offload_location_job(id)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling StorageApi->get_workspace_sync_to_offload_location_job: %s\n" % e)
```
...
# **offload_workspace**
    def TaskInfo offload_workspace(id, base_transfer_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.offload_workspace(id, base_transfer_request)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling StorageApi->offload_workspace: %s\n" % e)
```
...
# **request_workspace_offload**
    def WorkspaceOffloadRequest request_workspace_offload(id)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.request_workspace_offload(id)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling StorageApi->request_workspace_offload: %s\n" % e)
```
...
# **request_workspace_retrieval**
    def WorkspaceOffloadRequest request_workspace_retrieval(id)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.request_workspace_retrieval(id)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling StorageApi->request_workspace_retrieval: %s\n" % e)
```
...
# **retrieve_offloaded_workspace**
    def TaskInfo retrieve_offloaded_workspace(id, base_transfer_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_offloaded_workspace(id, base_transfer_request)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling StorageApi->retrieve_offloaded_workspace: %s\n" % e)
```
...
# **setup_workspace_offload**
    def TaskInfo setup_workspace_offload(id, setup_offload_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    setup_offload_request = SetupOffloadRequest(
        ...
        force_sync=True,
        offload_volume=1,
        offload_volume_path="offload_volume_path_example",
    ) # SetupOffloadRequest | 

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.setup_workspace_offload(id, setup_offload_request)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling StorageApi->setup_workspace_offload: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| A unique integer value identifying this workspace. |
 **setup_offload_request** | [**SetupOffloadRequest**](SetupOffloadRequest.md)|  |
...
# **sync_workspace_to_offload_location**
    def TaskInfo sync_workspace_to_offload_location(id, base_transfer_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.sync_workspace_to_offload_location(id, base_transfer_request)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling StorageApi->sync_workspace_to_offload_location: %s\n" % e)
```
