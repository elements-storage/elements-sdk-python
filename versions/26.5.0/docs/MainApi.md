...
[**register_batch_upload**](MainApi.md#register_batch_upload) | **POST** `/api/2/uploads/register-batch` | 
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    ldap_server_detail_update = LDAPServerDetailUpdate(
        ...
        group_members_search_filter="group_members_search_filter_example",
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    provider = "archiware" # str | Filter the returned list by `provider`. (optional)
    ordering = "ordering_example" # str | Which field to use when ordering the results. (optional)
    limit = 1 # int | Number of results to return per page. (optional)
    offset = 1 # int | The initial index from which to return the results. (optional)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    is_cloud = "is_cloud_example" # str | Filter the returned list by `is_cloud`. (optional)
    is_enabled = "is_enabled_example" # str | Filter the returned list by `is_enabled`. (optional)
    ordering = "ordering_example" # str | Which field to use when ordering the results. (optional)
    limit = 1 # int | Number of results to return per page. (optional)
    offset = 1 # int | The initial index from which to return the results. (optional)
    filter = "filter_example" # str |  (optional)
    ...
    # and optional values
    try:
        api_response = api_instance.get_all_users(username=username, home=home, full_name=full_name, groups=groups, is_cloud=is_cloud, is_enabled=is_enabled, ordering=ordering, limit=limit, offset=offset, filter=filter, filtering_mode=filtering_mode, include_allowed_fs_paths=include_allowed_fs_paths, include_effective_permissions=include_effective_permissions)
        pprint(api_response)
    except elements_sdk.ApiException as e:
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.get_current_node(type=type, name=name, address=address, ordering=ordering, limit=limit, offset=offset)
        pprint(api_response)
    except elements_sdk.ApiException as e:
...
# **get_license**
    def LicenseEndpointResponse get_license()
...
[**LicenseEndpointResponse**](LicenseEndpointResponse.md)
...
# **get_pwa_configuration**
    def PWAConfiguration get_pwa_configuration()
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example, this endpoint has no required or optional parameters
    try:
        api_response = api_instance.get_pwa_configuration()
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MainApi->get_pwa_configuration: %s\n" % e)
```
...
[**PWAConfiguration**](PWAConfiguration.md)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example, this endpoint has no required or optional parameters
    try:
        api_instance.get_pwa_icon()
    except elements_sdk.ApiException as e:
        print("Exception when calling MainApi->get_pwa_icon: %s\n" % e)
```
...
# **register_batch_upload**
    def [RegisterBatchUploadEndpointResponse] register_batch_upload(register_upload)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.register_batch_upload(register_upload)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MainApi->register_batch_upload: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **register_upload** | [**[RegisterUpload]**](RegisterUpload.md)|  |

### Return type

[**[RegisterBatchUploadEndpointResponse]**](RegisterBatchUploadEndpointResponse.md)

[[Back to top]](#) [[Back to API list]](../#documentation-for-api-endpoints) [[Back to Model list]](../#documentation-for-models) [[Back to README]](../)

# **register_upload**
    def register_upload(register_upload)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_instance.register_upload(register_upload)
    except elements_sdk.ApiException as e:
...
# **start_solr_reindex**
    def SolrReindexEndpointResponse start_solr_reindex(solr_reindex_endpoint_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.start_solr_reindex(solr_reindex_endpoint_request)
        pprint(api_response)
    except elements_sdk.ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **solr_reindex_endpoint_request** | [**SolrReindexEndpointRequest**](SolrReindexEndpointRequest.md)|  |
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    parameters_update = ParametersUpdate(
        ...
        sharing_smb_allow_anonymous=True,
...
# **update_pwa_configuration**
    def PWAConfiguration update_pwa_configuration(pwa_configuration_update)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_pwa_configuration(pwa_configuration_update)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling MainApi->update_pwa_configuration: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pwa_configuration_update** | [**PWAConfigurationUpdate**](PWAConfigurationUpdate.md)|  |
...
# **update_pwa_icon**
    def update_pwa_icon(image_upload_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_instance.update_pwa_icon(image_upload_request)
    except elements_sdk.ApiException as e:
        print("Exception when calling MainApi->update_pwa_icon: %s\n" % e)
```
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    smtp_configuration_update = SMTPConfigurationUpdate(
        ...
        reply_to_address="reply_to_address_example",
