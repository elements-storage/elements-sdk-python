...
[**get_all_queued_tasks**](AutomationApi.md#get_all_queued_tasks) | **GET** `/api/2/tasks/queues/{queue}` | 
...
[**get_job_variable_options**](AutomationApi.md#get_job_variable_options) | **POST** `/api/2/jobs/{id}/variables-options` | 
...
[**reorder_queued_task**](AutomationApi.md#reorder_queued_task) | **POST** `/api/2/tasks/queues/{queue}/reorder` | 
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    subtask_update = SubtaskUpdate(
        ...
        loop=True,
        loop_expression="loop_expression_example",
        loop_variable_name="loop_variable_name_example",
        parent=1,
        relative_to=1,
    ) # SubtaskUpdate | 
...
# **get_all_queued_tasks**
    def [QueuedTaskInfo] get_all_queued_tasks(queue)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.get_all_queued_tasks(queue)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling AutomationApi->get_all_queued_tasks: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.get_all_queued_tasks(queue, ordering=ordering, limit=limit, offset=offset)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling AutomationApi->get_all_queued_tasks: %s\n" % e)
```
...
[**[QueuedTaskInfo]**](QueuedTaskInfo.md)
...
# **get_job_variable_options**
    def [FieldOption] get_job_variable_options(id, field_definition)
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    field_definition = FieldDefinition(
        ...
        multiple_response=True,
        users_from_group_id=1,
    ) # FieldDefinition | 
    q = "q_example" # str |  (optional)

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.get_job_variable_options(id, field_definition)
        pprint(api_response)
    except elements_sdk.ApiException as e:
    ...
    # and optional values
    try:
        api_response = api_instance.get_job_variable_options(id, field_definition, q=q)
        pprint(api_response)
    except elements_sdk.ApiException as e:
        print("Exception when calling AutomationApi->get_job_variable_options: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| A unique integer value identifying this job. |
 **field_definition** | [**FieldDefinition**](FieldDefinition.md)|  |
 **q** | **str**|  | [optional]
...
# **reorder_queued_task**
    def reorder_queued_task(queue, reorder_task_request)
...
with elements_sdk.ApiClient(configuration) as api_client:
    api_instance = automation_api.AutomationApi(api_client)
    queue = "queue_example" # str | 
    reorder_task_request = ReorderTaskRequest(
        task_id="task_id_example",
        reorder_before_id="reorder_before_id_example",
        different_queue="different_queue_example",
    ) # ReorderTaskRequest | 

    # example passing only required values which don't have defaults set
    try:
        api_instance.reorder_queued_task(queue, reorder_task_request)
    except elements_sdk.ApiException as e:
        print("Exception when calling AutomationApi->reorder_queued_task: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **queue** | **str**|  |
 **reorder_task_request** | [**ReorderTaskRequest**](ReorderTaskRequest.md)|  |
