...
# **get_all_task_queues**
    ...
    def get_all_task_queues(ordering=ordering, limit=limit, offset=offset) -> InlineResponse2001 
...
# **get_all_task_types**
    ...
    def get_all_task_types(ordering=ordering, limit=limit, offset=offset) -> InlineResponse2002 
