...
# **check_auth_ticket**
    ...
    def check_auth_ticket(ticket) -> ElementsUserDetail 
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    ticket = elements_sdk.Ticket() # Ticket | 
...
# **login**
    ...
    def login(auth_login_endpoint_request) -> AuthLoginEndpointResponse 
...
with elements_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = elements_sdk.AuthApi(api_client)
    auth_login_endpoint_request = elements_sdk.AuthLoginEndpointRequest() # AuthLoginEndpointRequest | 
...
with elements_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = elements_sdk.AuthApi(api_client)
    password_reset_endpoint_request = elements_sdk.PasswordResetEndpointRequest() # PasswordResetEndpointRequest | 
...
with elements_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = elements_sdk.AuthApi(api_client)
    id = 56 # int | A unique integer value identifying this one time access token.
send_link_email_request = elements_sdk.SendLinkEmailRequest() # SendLinkEmailRequest | 
...
with elements_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = elements_sdk.AuthApi(api_client)
    impersonation_endpoint_request = elements_sdk.ImpersonationEndpointRequest() # ImpersonationEndpointRequest | 
