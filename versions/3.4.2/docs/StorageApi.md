...
# **delete_workspace**
    ...
    def delete_workspace(id, delete_content=delete_content)
...
# **update_workspace**
    ...
    def update_workspace(id, workspace_detail, delete_content=delete_content) -> WorkspaceDetail 
...
delete_content = True # bool |  (optional)
    ...
    try:
        api_response = api_instance.update_workspace(id, workspace_detail, delete_content=delete_content)
        pprint(api_response)
    except ApiException as e:
